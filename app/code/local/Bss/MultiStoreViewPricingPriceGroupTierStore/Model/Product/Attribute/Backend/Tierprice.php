...
*/
class Bss_MultiStoreViewPricingPriceGroupTierStore_Model_Product_Attribute_Backend_Tierprice
    extends Bss_MultiStoreViewPricingPriceGroupTierStore_Model_Product_Attribute_Backend_Groupprice_Abstract
{
    /**
    ...
    {
        return Mage::getResourceSingleton('multistoreviewpricingpricegrouptierstore/product_attribute_backend_tierprice');
    }
    ...
    {
        return Mage::helper('catalog')->__('Duplicate store tier price customer group and quantity.');
    }
