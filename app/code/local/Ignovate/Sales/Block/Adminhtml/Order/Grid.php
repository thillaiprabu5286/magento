 ...
 * Time: 1:01 AM
 */
class Ignovate_Sales_Block_Adminhtml_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('baddress' => 'sales_flat_order_address'),
            "main_table.entity_id = baddress.parent_id
    ...
    protected function _filterMobile($collection, $column)
    {
        if ($column->getFilter()->getValue() === null) {
            return;
        }

        $collection->getSelect()->where('baddress.telephone like ?', '%' . $column->getFilter()->getValue() . '%');
    }
}